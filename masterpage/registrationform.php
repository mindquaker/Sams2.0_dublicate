                    ...
                    <form name = "athregform" class = "form1" action = "regFormAction.php" method="POST">
                         ...
                         <div class="row">
                              <div class="col-sm-6 form-group">
                                   ...
                                   <input type="text" class="form-control" name="fname" pattern="[A-Za-z ,.'-]+" title="Use letters and ,.'- ONLY" required>
                              </div>

                              <div class="col-sm-6 form-group">
                                   <label for="lname">Last Name:</label>
                                   <input type="text" class="form-control" name="lname" pattern="[A-Za-z ,.'-]+" title="Use letters and ,.'- ONLY" required>
                              </div>
                         </div>
                         ...
                         <div class = "row">
                              <div class="form-group col-sm-3">
                                   ...
                                   <input type="text" class="form-control" name="city" pattern="[A-Za-z ,.'-]+" title="Use letters and ,.'- ONLY" required>
                              </div>
                              ...
                              <div class="form-group col-sm-3">
                                   ...
                                   <input type="text" class="form-control" name="zipcode" pattern="[0-9]{5}([0-9]{4})?" title="5 or 9 digit zip code ONLY" required />
                              </div>
                              ...
                              <div class="form-group col-sm-3">
                                   ...
                                   <input type="text" class="form-control" name="phone" pattern="\d{3}\d{3}\d{4}" title="10 digit phone number ONLY" required>
                              </div>
                                   </div>
                              ...
                              <div class="form-group col-sm-3">
                                   ...
                                   <input type="text" name="dob" class="form-control" pattern="\d{2}\/\d{2}\/\d{4}" title = "Date should be in mm/dd/yyyy format" required>
                              </div>

                              <div class="form-group col-sm-3">
                                   <label for="age">Age:</label>
                                   <input type="text" name="age" class="form-control" pattern="\d{1,3}" title="1-3 digit age" required>
                              </div>
                         ...
                         <div class = "row">
                              ...
                              <div class="form-group col-sm-6">
                                   ...
                                   <input type="text" class="form-control" name="hcPhone" pattern="\d{3}\d{3}\d{4}" title="10 digit phone number ONLY" required>
                              </div>
