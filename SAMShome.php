            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                   ...
                   <!-- <button id = "Paratristhion" class="btn btn-warning"><a href = "dashboard/paratristhion.html">Paratristhion</a></button>-->
                    ...
                    <button id = "PrintAthletes" class="btn btn-info"><a href = "#">Print All Atheltes</a></button>
                    <button id = "PrintResult" class="btn btn-info"><a href = "#">Print Result</a></button>
                    <button id = "Classify" class="btn btn-info"><a href = "#">Classify</a></button>
                </div>
